...
To install packages you can’t be connected to secure networks as security measures stop you connecting to the online library’s which store the packages.  
...
#### Step 2 
- Download from this link <a href="https://github.com/mcow7j/Python-Setup/blob/main/setup_selco_python_env%20v0.2.bat" download>here</a> or Copy the text from .bat file in this repo and save as a .bat script to a place locally on your computer.
...
- Save the file
- Now run the file. To do this double left click on the copied file in file explorer. If you get an error saying you can't connect is probably issues surrounding you rnetworks security.   
#### Step 3 (optional)
